...
class MyBeanTest {
    ...
    void test01()throws Exception{
        ...
        MetadataReader metadataReader = readerFactory.getMetadataReader("com.rookie.bigdata.springframework.core.type.metadata.metadatareader.bean.MyBean");
        ...
        // 获取方法上的注解信息
        for (MethodMetadata methodMetadata : metadataReader.getAnnotationMetadata().getAnnotatedMethods("com.rookie.bigdata.springframework.core.type.metadata.metadatareader.anno.MyAnnotation")) {
